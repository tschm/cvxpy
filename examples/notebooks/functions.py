...
ATOM_DEFINITIONS = [
  {"name":"abs",
   "usage": "abs(x)",
   "meaning": "$ |x| $",
   "domain": r"$ x \in \mathbf{R} $",
   "curvature": "Convex",
   "sign": "Positive",
   "monotonicity": [r"Increasing for $ x \geq 0 $",
                    r"Decreasing for $ x \leq 0 $"],
  },
  # {"name":"berhu",
  ...
  {"name":"norm2",
   ...
   "arguments": ("Takes a variable number of expressions followed by a parameter as arguments. "
                 ...
                 "The parameter must either be a number p with p >= 1 or be Inf. "
                 "The default parameter is 2."),
   "meaning": (r"$ \sqrt{x_{1}^{2} + \cdots + x_{k}^{2}} $"),
   "domain": r"$ x \in \mathbf{R}^{k} $",
   "curvature": "Convex",
   "sign": "Positive",
   "monotonicity": [r"Increasing for $ x \geq 0 $",
